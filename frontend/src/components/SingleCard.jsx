			...
			{fieldType === "trending" ? (
				<div className="w-full h-full relative group">
					...
					<div className="w-full h-full z-40 relative bg-gradient-to-b from-transparent to-[#000000be] rounded-xl  ">
						<div className="absolute bottom-1 left-2 md:bottom-2 md:left-3 lg:bottom-3 lg:left-5">
							...
							<p className="text-BodyM md:text-HeadingXS lg:text-HeadingM">{mediaData.title}</p>
						</div>
						...
						<div className="hidden group-hover:flex bg-[#ffffff35] absolute top-1/2 left-1/2 -translate-x-1/2 px-3 py-1 rounded-full gap-2 items-center -translate-y-1/2 cursor-pointer md:px-4 md:py-2">
							<IoPlayCircle className="text-xl md:text-4xl" />
							<span className="text-BodyS md:text-BodyM lg:text-HeadingXS">Play</span>
						</div>
					</div>
				</div>
			) : (
				<div className="w-full h-5/6 relative flex flex-col justify-between gap-2 group ">
					<div className="w-full h-5/6 relative ">
						...
						<div className="hidden group-hover:flex bg-[#ffffff35] absolute top-1/2 left-1/2 -translate-x-1/2 px-2 py-1 z-50 rounded-full gap-1 items-center -translate-y-1/2 cursor-pointer lg:px-6 lg:py-2 lg:gap-3">
						...
						<p className="flex items-center text-BodyS font-light md:text-BodyM">
							...
							<span className="flex items-center gap-1">
								{mediaData.mediaType === "movie" ? (
									...
									<>
										<TbDeviceTvOld /> <span className="truncate">Tv Series</span>
									</>
								)}
							</span>
							<LuDot className="text-BodyS md:text-BodyM" />
